    ...
    <div className="min-h-screen bg-gradient-to-b from-[#fff8f2] via-white to-[#f2fbff]">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <section className="mt-10">
          ...
          {foodLoading ? (
            <div className="text-gray-400 text-center py-6">먹거리 불러오는 중...</div>
              ...
              {foodData.map((food) => (
                ...
                >
                  ...
                  <div className="text-gray-400 text-xs mb-1">
                    {food.dist && `${Math.round(Number(food.dist))}m 거리`}
                  </div>
            ...
            <div className="text-gray-400 text-center py-6">주변 먹거리 정보를 찾을 수 없습니다.</div>
          )}
        </section>
        {/* 뒤로가기 */}
